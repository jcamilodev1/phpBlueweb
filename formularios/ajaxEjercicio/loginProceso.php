<?php
    ...
    $ensenar = $conectando -> query ("SELECT * FROM ajax WHERE id = 1");
    $resultado = $ensenar->fetch_assoc()['log_inicio'];
    loginBody($resultado);
    ...
    function loginBody($loginCrearCuenta){
        if ($loginCrearCuenta == 0){
            echo '
                <br><br>
                <div class="container">
